...
def experiment_iteration(model_dir, train_df1, train_df2, test_df1, test_df2, group1, group2, iteration, PPO_PARAMS, A2C_PARAMS, DDPG_PARAMS, results_file, returns_file):
    """
...
def run_experiment():
    ...
    results_file = os.path.join(result_dir, 'results.csv')
    returns_file = os.path.join(result_dir, 'returns.csv')
    ...
    experiment_iteration(
        model_dir, train_df1, train_df2, trade_df1, trade_df2, group1, group2, 
        iteration, PPO_PARAMS, A2C_PARAMS, DDPG_PARAMS, results_file, returns_file
    )

    update_combination_status(iteration, "completed")
